                ...
                {isEditing ? (
                    <div className="mb-6">
                        <textarea
                            ...
                            className="w-full px-3 py-2 text-slate-600 leading-relaxed border border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 min-h-37.5"
                        />
